...
interface Column {
    id: 'month' | 'totalsale' | 'totaldoing' | 'totaldelivery' ;
    label: string;
    minWidth?: number;
    align?: 'right';
...
const columns: readonly Column[] = [
    ...
    { id: 'totalsale', label: 'จำนวนป้ายที่ขายได้', minWidth: 100 },
    { id: 'totaldoing', label: 'กำลังจัดทำ', minWidth: 170 },
    { id: 'totaldelivery', label: 'ส่งเรียบร้อย', minWidth: 170 },
];
  ...
  return (
    ...
    <Paper sx={{ width: '100%', overflow: 'hidden' }}>
      ...
      <Button variant="outlined" sx={{mr:2 }} onClick={handleOnClickReport1}>
        ...
        <Button variant="contained"  sx={{bgcolor: '#5E35B1', mr:2 }} onClick={handleOnClickReport2}>
