...
interface Column {
    id: 'name' | 'totalitem' | 'totalavaliable' | 'totalused' ;
    label: string;
    minWidth?: number;
    align?: 'right';
...
const columns: readonly Column[] = [
    ...
    { id: 'name', label: 'ชื่ออุปกรณ์', minWidth: 100 },
    { id: 'totalitem', label: 'อุปกรณ์ทั้งหมด', minWidth: 170 },
    { id: 'totalavaliable', label: 'อุปกรณ์คงเหลือ', minWidth: 170 },
    { id: 'totalused', label: 'อุปกรณ์ที่ใช้', minWidth: 170 },
];
  ...
  return (
    ...
    <Paper sx={{ width: '100%', overflow: 'hidden' }}>
      ...
      <Box sx={{ width: '98%', m: 1, display: "flex", justifyContent: "flex-end", alignItems: "flex-end" }}>
        <Button variant="outlined" sx={{mr:2 }} onClick={handleOnClickReport1}>
          รายงานสรุปยอดขาย-กำไร ขั้นต้น
        </Button> 
        <Button variant="outlined"  sx={{ mr:2 }} onClick={handleOnClickReport2}>
          รายงานสรุปคำสั่งทำป้ายไฟ
        </Button> 
        <Button variant="contained" sx={{ bgcolor: '#5E35B1',mr:2 }} onClick={handleOnClickReport3}>
